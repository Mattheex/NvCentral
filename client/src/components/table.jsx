...
function Results({ title, results, routing, handleDelete }) {
  return (
    <div className="container-fluid p-0 tableColor overflow-auto">
      <div className="d-flex flex-grow-1 justify-content-between p-3 border-bottom">
                ...
                {Object.entries(row).map(([key, value], index) => {
                  ...
                  if (key === "Action") {
                    return (
                      <td key={index} className="align-middle">
                        {value && (
                          <Button variant="danger" value={value} onClick={handleDelete}>
                            Delete
                          </Button>
                        )}
                      </td>
